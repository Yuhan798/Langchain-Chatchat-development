...
from chatchat.server.knowledge_base.kb_doc_api import search_docs, search_temp_docs, search_docs_in_file
...
async def kb_chat(query: str = Body(..., description="用户输入", examples=["你好"]),
                ...
                file_name: str = Body(None, description="文件名称，支持 sql 通配符"),
                ):
    if mode == "local_kb":
        ...
        try:
            ...
            if mode == "local_kb":
                ...
                if file_name == None:
                    ...
                    docs = await run_in_threadpool(search_docs_in_file,
                                                query=query,
                                                knowledge_base_name=kb_name,
                                                top_k=top_k,
                                                score_threshold=score_threshold,
