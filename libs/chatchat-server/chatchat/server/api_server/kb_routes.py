# import sys
# sys.path.insert(0, '/chatchat/libs/chatchat-server')
...
kb_router.post(
    "/search_docs", response_model=List[tuple], summary="搜索知识库"
)(search_docs)

kb_router.post(
    "/search_docs_in_file", response_model=List[tuple], summary="在文件中搜索"
)(search_docs_in_file)
